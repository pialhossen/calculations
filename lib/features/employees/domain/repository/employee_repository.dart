...
abstract interface class EmployeeRepository {
  Future<EmployeeModel> createNewEmployee(String name, String number, double loanAmount);
  Future<EmployeeModel> updateEmployee(int id, String name, String number, double loanAmount);
